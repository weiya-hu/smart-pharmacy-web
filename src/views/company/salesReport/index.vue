...
//图形配置
import chart_One_Config from './config/chart_One_Config'
import chart_Two_Config from './config/chart_Two_Config'
import chart_Three_Config from './config/chart_Two_Config'
import chart_Four_Config from './config/chart_Two_Config'
...
/**图一基本配置*/
const chart_one_Option = ref(chart_One_Config)
/**图二基本配置*/
const chart_two_Option = ref(chart_Two_Config)
/**图三的基本配置*/
const chart_three_Option = ref(chart_Three_Config)
/**图四的基本配置*/
const chart_four_Option = ref(chart_Four_Config)
const legendEvent = {
  isRegistered: true,
