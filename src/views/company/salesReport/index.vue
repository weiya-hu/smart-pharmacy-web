...
//  店铺总的销售占比
  ...
  chart_three_Option.yAxis.data = ordinatesData
  chart_three_Option.series[0].data = brandSalesAccount
  chart_three_Option.series[1].data = brandSalesAccount
