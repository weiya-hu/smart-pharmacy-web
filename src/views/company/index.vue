    ...
    <div class="form-box">
      <el-form ref="formRef" :rules="rules" :model="form" label-width="105px">
        ...
        <el-form-item label="法人代表" prop="legalPersonId">
          <el-select v-model="form.legalPersonId" :disabled="inputType==='readey'" placeholder=" "
                     style="width: 500px;">
        ...
        <el-form-item label="企业类型" prop="corpType">
          <el-select v-model="form.corpType" :disabled="inputType==='readey'" placeholder=" " filterable
                     style="width: 500px;">
