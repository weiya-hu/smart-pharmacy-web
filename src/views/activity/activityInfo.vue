<template>
  <div class="app-container">
    ...
    <ActivityStepFirst ref="activityStepFirstRef" :handleType="handleType" :eventId="eventId"  v-show="step === 1"></ActivityStepFirst>
    <ActivityStepSecond v-if="eventId" :handleType="handleType" :eventId = "eventId"  ref="activityStepSecondRef" v-show="step === 2"></ActivityStepSecond>
