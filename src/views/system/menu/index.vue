   ...
   <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="visible" label="菜单可见">
         ...
         <el-table-column label="操作" width="120" fixed="right" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button type="text" icon="Plus" @click="handleAdd(scope.row)" v-hasPermi="['system:menu:add']"></el-button>
               <el-button type="text" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:menu:edit']"></el-button>
               <el-button type="text" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:menu:remove']"></el-button>
            </template>
         </el-table-column>
      </el-table>
            ...
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item label="显示排序" prop="orderNum">
                     <el-input-number v-model="form.orderNum" controls-position="right" :min="0" :max="30" style="width:100%" />
                  </el-form-item>
               </el-col>
               <el-col :span="24">
              ...
              <el-col :span="12">
               ...
               <el-col :span="12" v-if="form.menuType != 'F'">
                  <el-form-item>
                     ...
                     <el-switch v-model="form.isFrame" active-text="是" inactive-text="否" active-value='0' inactive-value="1" />
                  </el-form-item>
               </el-col>
               <el-col :span="12" v-if="form.menuType != 'F'">
